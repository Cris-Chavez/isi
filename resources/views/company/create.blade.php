        ...
        <div class="col-md-12 col-lg-12 col-xl-12">
           <!-- Header and Footer Card -->  
            <div class="card m-b-30">
                <h5 class="card-header">Creación de Empresa</h5>
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-4">                                                                    
                                ...
                                <div class="input-group mb-3">                                    
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Nombre de la empresa" value="{{ old('name') }}">                                        
                                </div>
                                @error('name')
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group mb-3">
                                    <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" placeholder="Correo electrónico de la empresa" value="{{ old('email') }}">
                                </div>
                                @error('email')
                                    <strong class="text-danger">{{ $message }}</strong>                          
                                @enderror                               
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control @error('web') is-invalid @enderror" id="web" name="web" placeholder="Sitio Web de la empresa" value="{{ old('web') }}">
                                </div>                             
                            </div>
